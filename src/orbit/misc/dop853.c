...
static double hinit (unsigned n, FcnEqDiff8 fcn, double x, double* y,
...
/* core integrator */
static int dopcor (unsigned n, FcnEqDiff8 fcn, double x, double* y, double xend,
		   double hmax, double h, double* rtoler, double* atoler,
		   int itoler, FILE* fileout, SolTrait8 solout, int iout,
...
/* front-end */
int dop853
 (unsigned n, FcnEqDiff8 fcn, double x, double* y, double xend, double* rtoler,
  double* atoler, int itoler, SolTrait8 solout, int iout, FILE* fileout, double uround,
